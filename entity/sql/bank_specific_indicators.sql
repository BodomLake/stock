...
-- ----------------------------
-- Table structure for bank_specific_indicators
-- ----------------------------
DROP TABLE IF EXISTS `bank_specific_indicators`;
CREATE TABLE `bank_specific_indicators`  (
  ...
  INDEX `ix_bank_specific_indicators_Id`(`Id`) USING BTREE,
  INDEX `ix_bank_specific_indicators_Code_Str`(`Code_Str`) USING BTREE,
  INDEX `ix_bank_specific_indicators_Code`(`Code`) USING BTREE
