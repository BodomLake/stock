...
-- ----------------------------
-- Table structure for profit_statement
-- ----------------------------
DROP TABLE IF EXISTS `profit_statement`;
CREATE TABLE `profit_statement`  (
  ...
  INDEX `ix_profit_statement_Id`(`Id`) USING BTREE,
  INDEX `ix_profit_statement_Code_Str`(`Code_Str`) USING BTREE,
  INDEX `ix_profit_statement_Code`(`Code`) USING BTREE
